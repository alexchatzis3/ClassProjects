 ...
 * Αν και οι δύο έχουν καύσιμα <1/4 τότε ανάβει κόκκινη ένδειξη. Αν η
 * μία από τις δύο έχει καύσιμα <1/4 τότε ανάβει πορτοκαλί ένδειξη.
 *
 */
public class TankApp {
    public static void main(String[] args) {
        ...
        System.out.println("Is orange :" + isOrange);
    }
}

...
public class CalculatorApp2 {
    ...
    /**
     * Returns the result based on choice and the input.If the input leads to
     * divide by zero error (in div or mod) then the result is Integer.MIN_VALUE
     *
     ...
     *
     * @return          the result of the operation base on choice and the
     *                  two input numbers.
     */

 ...
 * αντιστοιχεί σε αυτόν (από τον κώδικα ASCII). Κωδικοποίησε τους επόμενους
 * χαρακτήρες: (α) προσθέτοντας την ακέραια ASCII τιμή του καθένα από αυτούς με
 * τον κωδικό του προηγουμένου του, (β) παίρνοντας το υπόλοιπο της διαίρεσης του
 * αθροίσματος αυτού διά μία σταθερά. Υποθέτουμε πως τα μηνύματα τελειώνουν
 * με τον χαρακτήρα #. Γράψτε ένα πρόγραμμα Java που να υλοποιεί τον αλγόριθμο
 * κρυπτογράφησης έτσι ώστε το κωδικοποιημένο μήνυμα που προκύπτει να είναι μία
 * ακολουθία  ακεραίων που τελειώνει με -1. Γράψτε και τον αλγόριθμο
 * αποκρυπτογράφησης που λαμβάνει ως είσοδο μία ακολουθία ακεραίων που τελειώνει
...
public class CryptographyApp {
    ...
    public static  char decipher(int cipher, int prev, int key) {
        ...
        // πάρουμε θετικό και άρα για να τρέξει σωστά το modulo.
